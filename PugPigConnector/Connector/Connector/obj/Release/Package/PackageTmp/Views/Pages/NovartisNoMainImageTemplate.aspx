...
<html>
    ...
    <head id="Head1" runat="server">
      ...
      <link rel="stylesheet" type="text/css" href="/css/no-main-image.css" />
    </head>
...
<body class="section-a">
  ...
  <article>
      <h1>No Main Image</h1>
      <h3>Just smaller images, inline with the content, and even a standfirst and blockquote thrown in</h3>
      ...
      <blockquote>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas risus ligula, lobortis quis iaculis vitae, adipiscing sagittis eros. Sed eu tempor metus.</blockquote>
      ...
      <figure>
        <div><img src="/img/article-e1.jpg" /></div>
      </figure>
