<%@ Page Language="c#" Inherits="PugPigConnector.Views.Pages.IndexPageTemplate127" CodeBehind="IndexPageTemplate127.aspx.cs" %>
    ...
    <body class="section-a">  
       ...
       <article> 
         ...
         <ol class='articles-list first'>
           <EPiServer:Property ID="TextContent"  PropertyName="ArticleList" runat="server" />
         </ol> 
       </article> 
    </body>
